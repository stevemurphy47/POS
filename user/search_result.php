	...
	<?php
		...
		while($row=mysqli_fetch_array($query)){
			...
			?>
				<div class="col-lg-3">
				<div>
					<a href="product.php?id=<?php echo $row['productid']; ?>"><img src="../<?php if (empty($row['photo'])){echo "upload/noimage.jpg";}else{echo $row['photo'];} ?>" style="width: 230px; height:230px; padding:auto; margin:auto;" class="thumbnail"></a>
