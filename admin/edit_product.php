<?php
	...
	mysqli_query($conn,"update product set product_name='$name',details='$details', supplierid='$supplier', categoryid='$category', product_price='$price', photo='$location', product_qty='$qty' where productid='$id'");
